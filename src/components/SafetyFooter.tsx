...
export const SafetyFooter = () => {
  ...
  return (
    <footer className="w-full pt-20 pb-10 px-6 bg-[#FFF5F0]/80 backdrop-blur-md text-[#1A1A1A] overflow-hidden relative border-t border-[#FFD8C2]">
      <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#E76F51]/30 to-transparent" />
      ...
      <div className="max-w-6xl mx-auto">
        {!isDashboard && (
          ...
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center mb-6 group">
              <Image
                ...
                width={120}
                height={36}
                className="object-contain mix-blend-multiply opacity-90 group-hover:opacity-100 transition-all duration-300"
              />
            </Link>
            ...
            <div className="flex gap-4">
              <Globe size={16} className="text-slate-600 hover:text-[#E76F51] cursor-pointer transition-colors" />
              <ExternalLink size={16} className="text-slate-600 hover:text-[#1A1A1A] cursor-pointer transition-colors" />
              <Activity size={16} className="text-slate-600 hover:text-[#E76F51] cursor-pointer transition-colors" />
            </div>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="font-black mb-6 uppercase text-[10px] tracking-[0.2em] text-[#E76F51]">Platform</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-black mb-6 uppercase text-[10px] tracking-[0.2em] text-[#E76F51]">Clinical Support</h4>
            <ul className="space-y-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest">
              <li className="flex items-center gap-3"><Mail size={14} className="text-[#E76F51]/60" /> support@oncura.ai</li>
              <li className="flex items-center gap-3"><Phone size={14} className="text-[#E76F51]/60" /> +1 (800) DERM-AI</li>
              <li className="flex items-center gap-3"><MapPin size={14} className="text-[#E76F51]/60" /> Silicon Valley, CA</li>
            </ul>
          </div>
        </div>
        )}
        ...
        <div className="p-8 rounded-3xl bg-white/60 border border-[#FFD8C2] mb-12 shadow-sm">
          <div className="flex items-center gap-2 mb-4 text-[#E76F51]">
            <ShieldCheck size={16} />
            <span className="text-[10px] font-black uppercase tracking-[0.2em]">Safety Protocol</span>
          </div>
          <p className="text-[11px] text-slate-600 leading-relaxed font-medium">
            oncura is an educational monitoring tool. It is <span className="text-[#1A1A1A] font-bold">not a replacement</span> for professional medical advice.
